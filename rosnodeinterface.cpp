...
// Generated 12-Jul-2021 20:45:49
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"followerstoppermax4rl\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(followerstoppermax4rl_M, (NULL));
        followerstoppermax4rl_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(followerstoppermax4rl_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(followerstoppermax4rl_M)
                == (NULL)) || rtmGetStopRequested(followerstoppermax4rl_M));
    ...
    void NodeInterface::terminate(void)
    {
      if (mBaseRateThread.get()) {
        ...
        followerstoppermax4rl_terminate();
        mNode.reset();
      }
    }
    ...
    {
      mRunModel = (rtmGetErrorStatus(followerstoppermax4rl_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
